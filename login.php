...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="LoginWindow">
            <div>
            	<form action="http://localhost:8080/MyTKP/index.php/Home/User/login" method="post" id="ff">
            		<input type="hidden" name="controller" value="UserController"/>
            		<input type="hidden" name="methodName" value="login"/>
                    <div class="login">
                        <p><input type="text" name="userName" id="id" placeholder="用户名" /></p>
